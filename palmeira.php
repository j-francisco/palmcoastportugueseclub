  ...
  <body>
    ...
    <div class="container palmeira">
      ...
      <div class="row main">
        ...
        <? 
          $latestVersion = array("name" => "July 2016", "url" => "http://issuu.com/palmcoastportugueseclub/docs/palmeira_july_2016", "thumbnail" => "images/palmeira_thumbs/july2016_thumb.jpg");
          $oldVersions = [
